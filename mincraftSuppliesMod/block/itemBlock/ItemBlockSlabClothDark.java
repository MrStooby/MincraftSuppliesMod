...
public class ItemBlockSlabClothDark extends ItemBlock {

	private final boolean isFullBlock;
	private final Block theHalfSlab;
	private final Block doubleSlab;

	public ItemBlockSlabClothDark(int id) {
		super(id);
		this.theHalfSlab = MincraftSuppliesMod.singleSlabClothDark;
		this.doubleSlab = MincraftSuppliesMod.doubleSlabClothDark;

		if (id - 256 == MincraftSuppliesMod.doubleSlabClothDark.blockID) {
	...
	public String getUnlocalizedName(ItemStack stack) {
		return ((SlabClothDark) theHalfSlab).getFullSlabName(stack.getItemDamage());
	}
