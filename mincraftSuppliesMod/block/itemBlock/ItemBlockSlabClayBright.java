...
public class ItemBlockSlabClayBright extends ItemBlock {

	private final boolean isFullBlock;
	private final Block theHalfSlab;
	private final Block doubleSlab;

	public ItemBlockSlabClayBright(int id) {
		super(id);
		this.theHalfSlab = MincraftSuppliesMod.singleSlabClayBright;
		this.doubleSlab = MincraftSuppliesMod.doubleSlabClayBright;

		if (id - 256 == MincraftSuppliesMod.doubleSlabClayBright.blockID) {
	...
	public String getUnlocalizedName(ItemStack stack) {
		return ((SlabClayBright) theHalfSlab).getFullSlabName(stack.getItemDamage());
	}
