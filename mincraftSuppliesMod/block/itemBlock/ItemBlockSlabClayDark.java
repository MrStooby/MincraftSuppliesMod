...
public class ItemBlockSlabClayDark extends ItemBlock {

	private final boolean isFullBlock;
	private final Block theHalfSlab;
	private final Block doubleSlab;

	public ItemBlockSlabClayDark(int id) {
		super(id);
		this.theHalfSlab = MincraftSuppliesMod.singleSlabClayDark;
		this.doubleSlab = MincraftSuppliesMod.doubleSlabClayDark;

		if (id - 256 == MincraftSuppliesMod.doubleSlabClayDark.blockID) {
	...
	public String getUnlocalizedName(ItemStack stack) {
		return ((SlabClayDark) theHalfSlab).getFullSlabName(stack.getItemDamage());
	}
